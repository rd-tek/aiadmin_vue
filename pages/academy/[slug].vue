        ...
        <div class="my-coaching-list">
                          ...
                          >
                            <defs>
                              <linearGradient
                                ...
                                y2="0"
                              >
                                <stop offset="50%" stop-color="#FF7519" />
          ...
          <div class="floating-box">
            <div class="floating-box-image" v-if="coachingView.thumbnail">
              <div
                class="floating-box-image-inner"
                :style="{
                  backgroundImage: `url(${common.getImg(
                    coachingView.thumbnail,
                  )})`,
                }"
              ></div>
...
useHead({
  ...
  title: "아카데미",
  meta: [{ name: "description", content: "아카데미 상세 페이지 입니다." }],
});
</script>
