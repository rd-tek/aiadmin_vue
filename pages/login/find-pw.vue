    ...
    <div class="login-wrap">
      ...
      <div class="form">
        ...
        <div class="form-input">
          <div class="form-input-sub align-left">
            아이디와 핸드폰 번호를 입력합니다.
          </div>
        </div>
        <div class="form-input">
          <div class="form-input-wrap">
            <div class="input-text">
              <input type="text" required v-model="form.expert_id" />
              <label>아이디</label>
...
useHead({
  ...
  title: '비밀번호 찾기',
  meta: [
    { name: 'description', content: '비밀번호 찾기 페이지 입니다.' }
  ]
})

const handleFindPw = async () => {
  try {
    const { message } = await authApi._findPw(form.value);
