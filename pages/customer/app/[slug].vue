    ...
    <div class="customer-member detail">
        <div class="detail-wrap" :class="{ 'is-move': detailMove }" ref="detailRef">
            ...
            <div class="page-area">
                <div class="page-area-list">
                    ...
                    <span class="cnt">
                        <nuxt-link
                            v-if="prevPost"
                            :to="`/customer/app/${prevPost.notice_app_pk}`"
                            >
                            {{ prevPost.title }}
                        </nuxt-link>
                ...
                <div class="page-area-list">
                    ...
                    <span class="cnt">
                        <nuxt-link
                            v-if="nextPost"
                            :to="`/customer/app/${nextPost.notice_app_pk}`"
                            >
                            {{ nextPost.title }}
                        </nuxt-link>
            ...
            <div class="btn-wrap column-reverse">
                <nuxt-link to="/customer/app" class="btn-md-line">목록보기</nuxt-link>
                  <button
                        type="button"
                        class="btn-md-line"
                        @click="handleDelete()"
...
const getNoticeDetail = async () => {
  const res = await customerApi._appNoticeview(route.params.slug);
...
const handleEdit = () => {
  router.push(`/customer/app/edit/${route.params.slug}`);
};
...
const handleDelete = async () => {
  ...
  try {
    const res = await customerApi._appNoticeDelete(
      route.params.slug,
    );
