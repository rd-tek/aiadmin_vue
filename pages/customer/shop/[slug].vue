    ...
    <div class="customer-member detail">
        <div class="detail-wrap" :class="{ 'is-move': detailMove }" ref="detailRef">
            ...
            <div class="page-area">
                <div class="page-area-list">
                    ...
                    <span class="cnt">
                        <nuxt-link
                            v-if="prevPost"
                            :to="`/customer/shop/${prevPost.notice_shop_pk}`"
                            >
                            {{ prevPost.title }}
                        </nuxt-link>
                ...
                <div class="page-area-list">
                    ...
                    <span class="cnt">
                        <nuxt-link
                            v-if="nextPost"
                            :to="`/customer/shop/${nextPost.notice_shop_pk}`"
                            >
                            {{ nextPost.title }}
                        </nuxt-link>
            ...
            <div class="btn-wrap column-reverse">
                <nuxt-link to="/customer/shop" class="btn-md-line">목록보기</nuxt-link>
                  <button
                        type="button"
                        class="btn-md-line"
                        @click="handleDelete"
...
const getNoticeDetail = async () => {
  const res = await customerApi._ownerNoticeview(route.params.slug);
...
const handleDelete = async () => {
  ...
  try {
    const res = await customerApi._ownerNoticeDelete(
      route.params.slug,
    );
